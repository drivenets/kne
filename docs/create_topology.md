...
Field           | Type       | Description
--------------- | ---------- | -----------
`operator`      | string     | Path of the yaml file to create a Cdnos operator in the cluster. The validated operator for use with KNE can be found [here](https://github.com/drivenets/kne/tree/main/manifests/controllers/cdnos/manifest.yaml).
