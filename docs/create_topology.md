...
Field           | Type       | Description
--------------- | ---------- | -----------
`operator`      | string     | Path of the yaml file to create an IxiaTG operator in the cluster. The validated operator for use with KNE can be found [here](https://github.com/drivenets/kne/tree/main/manifests/keysight/ixiatg-operator.yaml).
`configMap`     | string     | Path of the yaml file to create an IxiaTG config map in the cluster. The validated config map for use with KNE can be found [here](https://github.com/drivenets/kne/tree/main/manifests/keysight/ixiatg-configmap.yaml).
